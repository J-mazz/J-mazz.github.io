...
// Demo link handler (placeholder for future demo)
document.addEventListener('DOMContentLoaded', () => {
    const demoLinks = document.querySelectorAll('.demo-link');
    demoLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            e.preventDefault();
            alert('Demo coming soon! The Veritas-lens project is currently in development. Check back later for a live demonstration.');
        });
    });
});
